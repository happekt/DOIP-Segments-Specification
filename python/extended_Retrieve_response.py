...
#   filename:  0.DOIP_Op.Extended-Retrieve-Response.json
#   version:   0.30.1
...
class ExtendedRetrieveResponse(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    output: Optional[DoipDoSerialization] = Field(
        None, description='serialization of a digital object'
    )
