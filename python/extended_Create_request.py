...
#   filename:  0.DOIP_Op.Extended-Create-Request.json
#   version:   0.30.1
...
class Record(BaseModel):
    field_21_T11966_FdoProfile: str = Field(
        ...,
        alias='21.T11966/FdoProfile',
...
class ExtendedCreateRequest(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    ...
    clientId: str = Field(..., description='clientId: the identifier of the client.')
    targetId: str = Field(
        ...,
    ...
    operationId: Literal['0.DOIP/Op.Extended-Create'] = Field(
