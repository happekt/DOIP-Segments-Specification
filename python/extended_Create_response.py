...
#   filename:  0.DOIP_Op.Extended-Create-Response.json
#   version:   0.30.1
...
class Attributes(BaseModel):
    record: Dict[str, Any] = Field(
        ...,
        description='record: the JSON object containing all type-value-pairs that were written into the PID record at DO creation.',
    )
...
class ExtendedCreateResponse(BaseModel):
    class Config:
        extra = Extra.forbid
