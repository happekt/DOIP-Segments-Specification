...
#   filename:  0.DOIP_Op.Extended-Update-Request.json
#   version:   0.30.1
...
class Attributes(BaseModel):
    record: Dict[str, Any] = Field(
        ...,
        description='record: the JSON object containing all type-value-pairs that are used to override the entries in the PID record.',
    )
